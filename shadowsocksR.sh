...
echo "# Author: Teddysun <i@Rtg28343U>                         #"
...
pre_install(){
    ...
    read -p "(Default password: Rtg28343U):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="Rtg28343U"
    echo
    echo "---------------------------"
...
install(){
    ...
    if [ -f /usr/local/shadowsocks/server.py ]; then
        ...
        echo "ShadowsocksR install failed, please Email to Teddysun <i@Rtg28343U> and contact"
        install_cleanup
        exit 1
    fi
}
